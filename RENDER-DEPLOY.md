...
Tu URL será algo como: **`https://hypercix.onrender.com`**
...
| URL | Qué debe ver |
|---|---|
| `https://hypercix.onrender.com/` | La tienda con tu producto |
| `https://hypercix.onrender.com/api/health` | `{"status":"ok"}` |
| `https://hypercix.onrender.com/admin/login.html` | Pantalla de login |
